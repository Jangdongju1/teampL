...
@Getter
public class PatchIssueCommentResponse {

    public static ResponseEntity<ApiResponse<PatchIssueCommentResponse>> success() {
        ApiResponse<PatchIssueCommentResponse> responseBody = new ApiResponse<>(
    ...
    public static ResponseEntity<ResponseDto> notExistComment() {
        return ResponseDto.notExistComment();
    }
}
